...
function UsaVisa() {
    return (
        <>
            ...
            <div className='text-center flex items-end pb-5 pl-5 usa-banner pt-5'> <span className="text-[56px] pt-11 text-[#01319F] w-full  font-bold leading-none">
                    ...
                    <div class="flex justify-center flex-wrap -m-4">
                        <div class="p-4 md:w-full">
                            <div class="h-full border-2 md:flex border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img class="h-[450px] md:h-[400px] w-full md:w-[50%]  object-center" src="./US-F1-Visa.png" alt="blog" />
